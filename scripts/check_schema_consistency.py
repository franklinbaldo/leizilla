...
# `anexo.1`).
#
# Generic URN-LEX descriptor grammar. This accepts documented descriptor
# forms such as 72-a, lex-16 and estatuto.idoso. The producer-side legal
# number grammar stays intentionally stricter in parser.py::_RE_NUMERO.
# Keep this boundary aligned with etl.py and the XSD.
