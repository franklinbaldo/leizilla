...
fronts:
  ...
  - id: "public-surface-auditability"
    ...
    issues: [167, 229]
    next_action: "kr-public-responsive-audit and kr-law-page-regression-tests are met. #229 closed (PR #230). kr-public-semantic-legibility's #167 slice is now resolved this session (fixture + copy fix) — see that KR; only the GitHub close itself is outstanding."
    key_results:
