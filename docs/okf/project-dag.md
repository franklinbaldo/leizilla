...
fronts:
  ...
  - id: "pipeline-convergence"
    ...
    next_action: "Consolidate #178/#179 on current main: keep the harvest fallback regression tests and the real cdx-auto consumers, remove contradictory RFC status text, then close #176 only after the unified change is merged."
